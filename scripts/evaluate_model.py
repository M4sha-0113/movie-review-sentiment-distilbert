...
if __name__ == "__main__":
    ...
    evaluate_model("../datasets/rotten_tomatoes/clean_data/pos_data.csv", "../datasets/rotten_tomatoes/clean_data/neg_data.csv", text_column="review_content", model_dir="./stanford_dataset_train_results/checkpoint-4221", output_file="rotten_tomatoes_test_results.txt")
