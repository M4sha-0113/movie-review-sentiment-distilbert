...
if __name__ == "__main__":
    ...
    # preprocess_data("../datasets/rotten_tomatoes/raw_data/25k_subset.csv", "review_content", "review_type", "Fresh", "Rotten")
    # preprocess_data("../datasets/amazon/raw_data/25k_subset.csv", 2, 0, 2, 1)

    ## then comment what we just ran and uncomment the lines below to preprocess the full datasets from rotten tomatoes and amazon.
